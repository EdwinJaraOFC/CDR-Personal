...
<p align="justify">
<strong>Nota:</strong> Un evento de prueba es un objeto JSON que imita la estructura de las solicitudes emitidas por los servicios AWS para invocar una función de Lambda. Se utiliza para ver el resultado de la invocación de la función. Para invocar la función sin guardar un evento, configure el evento JSON y luego elija probar.</p>
<p align= "center">
