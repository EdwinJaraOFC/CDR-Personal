...
# Se implementó la funcionalidad para usar colas de prioridad con diferentes colas SQS.
# Se añadió registro de logs para eventos de envío y recepción de notificaciones.
# Se mejoró el manejo de reintentos y se agregó el registro de intentos fallidos en la cola de mensajes muertos.
